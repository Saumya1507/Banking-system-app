...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.example.bankingsystemapp.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(com.example.bankingsystemapp.HistoryList historyList, List<Model> modelList) {
